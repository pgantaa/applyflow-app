    ...
    <div className="max-w-6xl mx-auto p-6 space-y-6">
      <div className="grid md:grid-cols-2 gap-6 items-center">
        <div className="space-y-4">
          <h1 className="text-4xl font-bold tracking-tight">We apply to jobs for you — with customized resumes & cover letters.</h1>
          <p className="text-muted-foreground">Paste job links, track progress, get interviews. Human assistants + AI tailoring. No bots to get you banned.</p>
          ...
          <div className="flex items-center gap-4 pt-2 text-sm text-muted-foreground">
            <div className="flex items-center gap-1"><CheckCircle2 className="h-4 w-4 text-primary"/> Format-locked tailored resumes</div>
            <div className="flex items-center gap-1"><CheckCircle2 className="h-4 w-4 text-primary"/> Manual submission by assistants</div>
          </div>
        </div>
      ...
      <div className="grid md:grid-cols-3 gap-4">
        {["Paste job link","Tailored docs","Human apply"].map((t,i)=> (
          <Card key={i}>
            <CardHeader><CardTitle className="text-lg">{t}</CardTitle></CardHeader>
